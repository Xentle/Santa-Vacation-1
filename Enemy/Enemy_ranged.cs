...
public class Enemy_ranged : LivingEntity
{
    ...
    IEnumerator FireObject()
    {
        ...
        yield return new WaitForSeconds(0.6f); //we don't want it to be next frame
        ...
        canAttack = true;
            ...
            myProjectile.transform.position = rangedMonsterTransform.position + new Vector3(0, 2.0f, 0);
